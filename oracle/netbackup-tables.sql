...
CREATE UNIQUE INDEX NETBACKUP.PK_ROBOT ON NETBACKUP.ROBOT
(ROBOT_NUMBER)
LOGGING
TABLESPACE NETBACKUP_IDX
PCTFREE    10
...
CREATE UNIQUE INDEX NETBACKUP.UI_SU_NAME ON NETBACKUP.STORAGEUNIT
(NAME)
LOGGING
TABLESPACE NETBACKUP_IDX
PCTFREE    10
...
CREATE UNIQUE INDEX NETBACKUP.UI_VOLUMEGROUP_NAME ON NETBACKUP.VOLUMEGROUP
(NAME)
LOGGING
TABLESPACE NETBACKUP_IDX
PCTFREE    10
...
CREATE UNIQUE INDEX NETBACKUP.UI_VOLUMEPOOL_NAME ON NETBACKUP.VOLUMEPOOL
(NAME)
LOGGING
TABLESPACE NETBACKUP_IDX
PCTFREE    10
...
CREATE UNIQUE INDEX NETBACKUP.UI_POLICY_NAME ON NETBACKUP.POLICY
(NAME)
LOGGING
TABLESPACE NETBACKUP_IDX
PCTFREE    10
...
CREATE UNIQUE INDEX NETBACKUP.UI_VAULT_NAME ON NETBACKUP.VAULT
(NAME)
LOGGING
TABLESPACE NETBACKUP_IDX
PCTFREE    10
...
ALTER TABLE NETBACKUP.RETENTION ADD (
  CONSTRAINT PK_RETENTION
  PRIMARY KEY
  (IND)
  USING INDEX NETBACKUP.PK_RETENTION
  ENABLE VALIDATE);
...
ALTER TABLE NETBACKUP.ROBOT ADD (
  ...
  PRIMARY KEY
  (ROBOT_NUMBER)
  USING INDEX NETBACKUP.PK_ROBOT
  ENABLE VALIDATE);
...
ALTER TABLE NETBACKUP.STORAGEUNIT ADD (
  ...
  ENABLE VALIDATE,
  CONSTRAINT UI_SU_NAME
  UNIQUE (NAME)
  USING INDEX NETBACKUP.UI_SU_NAME
  ENABLE VALIDATE);
...
ALTER TABLE NETBACKUP.STORAGEUNIT ADD (
  ...
  REFERENCES NETBACKUP.ROBOT (ROBOT_NUMBER)
  ENABLE VALIDATE);
...
ALTER TABLE NETBACKUP.SLP_DETAIL ADD (
  ...
  REFERENCES NETBACKUP.RETENTION (IND)
  ENABLE VALIDATE,
...
ALTER TABLE NETBACKUP.VAULT ADD (
  ...
  CONSTRAINT R_72 
  FOREIGN KEY (ROBOT_NUMBER) 
  REFERENCES NETBACKUP.VAULTROBOT (ROBOT_NUMBER)
  ENABLE VALIDATE);
